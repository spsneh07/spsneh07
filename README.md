...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=26&duration=3000&pause=1000&color=2E9EF7&center=true&vCenter=true&width=600&lines=Hi+there%2C+I'm+Sneh+Prasad;AI%2FML+%2B+Full+Stack+Developer;B.Tech+CSE+(AI+%26+ML)+%40+SRM;Building%2C+Publishing%2C+Learning" alt="Typing SVG" />
...
<p>
  ...
  <a href="https://portfolio-navy-nu-49.vercel.app/"><img src="https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=vercel&logoColor=white" /></a>
...
- 🎓 B.Tech, Computer Science & Engineering (AI & ML) — SRM Institute of Science and Technology, Chennai (2024–2028), CGPA 8.92
- 🔭 Currently preparing for **Software Engineering & AI/ML internships**, sharpening DSA
- 🌱 Learning: DSA in C++, System Design fundamentals, deeper Azure/cloud, AI engineering
- 💼 Experience across **ML/DL research pipelines** and **full-stack (MERN) development**
- 📄 Co-author on 4 published papers (IEEE Xplore, Springer Nature, Taylor & Francis) and inventor on 2 filed patents
- ⚡ Interests: AI/ML, Data Science, Backend & Full-Stack Development, Cloud (Azure), and getting better at DevOps
...
<details open>
<summary><b>AI & Machine Learning Intern — Centre for Development of Advanced Computing (C-DAC), Pune</b> (May 2026 – Jul 2026)</summary>
<br/>
...
- Built, benchmarked, and reported ML/DL model performance (RMSE, MAE, MSE, R²) for Remaining Useful Life (RUL) prediction
- Iteratively tuned model architectures and hyperparameters across experimental runs

</details>

<details>
<summary><b>Full Stack Developer Intern — Vital Skills (in collaboration with Tech Kriti, IIT Kanpur)</b> (May 2025 – Jul 2025)</summary>
<br/>

- Shipped full-stack features for **SynergyHub** using the MERN stack
- Built and integrated REST APIs across the application
...
AI/ML pipeline predicting Remaining Useful Life (RUL) of turbofan engines on the NASA C-MAPSS dataset.

**Tech:** Python · Scikit-learn · TensorFlow · Keras
**Highlights:** 7 models built (Linear Regression, Random Forest, ANN, CNN, RNN, LSTM, GRU), benchmarked via RMSE/MAE/MSE/R²

[![Repo](https://img.shields.io/badge/Repository-181717?style=for-the-badge&logo=github&logoColor=white)](<REPO_URL_AIRCRAFT_ENGINE>)

</td>
<td width="50%">

### 🛡️ AI Phishing Website Detection
Attention-based deep neural network for phishing website detection — published research work.

**Tech:** Deep Learning · Attention Mechanisms · NLP
...
ML-based fault detection system for bearing failure classification.

**Tech:** Python · Scikit-learn · NumPy · Pandas · Matplotlib
**Highlights:** Random Forest & Gradient Boosting classifiers developed and evaluated

[![Repo](https://img.shields.io/badge/Repository-181717?style=for-the-badge&logo=github&logoColor=white)](<REPO_URL_BEARING_FAULT>)

</td>
<td width="50%">

### 🏦 Modern Banking Application
Full-stack banking application handling account and transaction workflows.

**Tech:** React · Next.js · TypeScript
**Highlights:** End-to-end account and transaction flows

[![Repo](https://img.shields.io/badge/Repository-181717?style=for-the-badge&logo=github&logoColor=white)](<REPO_URL_BANKING_APP>)
[![Demo](https://img.shields.io/badge/Live_Demo-000000?style=for-the-badge&logo=vercel&logoColor=white)](<DEMO_URL_BANKING_APP>)

</td>
</tr>
</table>

> <!-- TODO: Portfolio Website project card — add once repo/tech/description exist.
>      Not included above since there's nothing concrete to describe yet. -->
...
<!-- TODO: add future certifications here as you earn them -->
...
<img src="https://github-readme-stats.vercel.app/api?username=spsneh07&show_icons=true&theme=tokyonight&hide_border=true&count_private=true" alt="GitHub Stats" height="165"/>
<img src="https://streak-stats.demolab.com?user=spsneh07&theme=tokyonight&hide_border=true" alt="GitHub Streak" height="165"/>

<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=spsneh07&layout=compact&theme=tokyonight&hide_border=true" alt="Top Languages" height="165"/>

<img src="https://github-readme-activity-graph.vercel.app/graph?username=spsneh07&theme=tokyo-night&hide_border=true" alt="Activity Graph" width="90%"/>

<img src="https://github-profile-trophy.vercel.app/?username=spsneh07&theme=tokyonight&no-frame=true&row=1&column=6" alt="Trophies" width="90%"/>

</div>

<!--
  NOTE ON WIDGET RELIABILITY:
  github-readme-stats.vercel.app and streak-stats.demolab.com are shared
  public deployments and can hit Vercel/API rate limits, causing broken
  images. If that happens, self-host these widgets on your own Vercel
  deployment (fork the repos: anuraghazra/github-readme-stats and
  DenverCoder1/github-readme-streak-stats) and swap the URLs above to
...
<img src="https://visitor-badge.laobi.icu/badge?page_id=spsneh07.spsneh07" alt="Visitor Badge"/>
